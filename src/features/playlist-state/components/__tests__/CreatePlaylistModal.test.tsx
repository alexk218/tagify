...
import CreatePlaylistModal from "@/features/playlist-state/components/CreatePlaylistModal";
...
describe("CreatePlaylistModal", () => {
  const mockProps = {
    ...
    activeTagFormula: "House AND Uplifting",
    ratingFilters: [4, 5],
    energyMinFilter: 6,
  ...
  describe("Form Submission", () => {
    it("should call onCreatePlaylist with auto-generated values for smart playlists", async () => {
      ...
      expect(mockProps.onCreatePlaylist).toHaveBeenCalledWith(
        ...
        "SMART PLAYLIST | Tags: House AND Uplifting | Rating: 4, 5 ★ | Energy: ≥6 | BPM: 120 - 130",
        true,
        true
      );
    });
    ...
    it("should use auto-generated default values when inputs are empty", async () => {
      ...
      expect(mockProps.onCreatePlaylist).toHaveBeenCalledWith(
        ...
        "Tags: House AND Uplifting | Rating: 4, 5 ★ | Energy: ≥6 | BPM: 120 - 130",
        false,
        false
      );
    });
  ...
  describe("Modal Interaction", () => {
    ...
    it("should not close modal when clicking modal content", async () => {
      ...
      // Click on modal content itself (not overlay)
      const modalContent =
        container.querySelector('[class*="modalContent"]') ||
